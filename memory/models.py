...
class ContentDraft(Base):
    ...
    # Video (generated by video pipeline for TikTok/YouTube/Reels)
    video_path = Column(String(500))                              # local path to final .mp4
    video_srt_path = Column(String(500))                          # path to .srt subtitles
    video_status = Column(String(20))                             # pending|rendering|ready|failed|null
